...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionexetute_from_start_node = QAction(MainWindow)
        self.actionexetute_from_start_node.setObjectName(u"actionexetute_from_start_node")
        ...
        self.menuTools.addAction(self.actionexetute_from_start_node)
        self.menuTools.addAction(self.actionexecute_graph)
        self.toolBar.addAction(self.actionexetute_from_start_node)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionexecute_graph.setIconText(QCoreApplication.translate("MainWindow", u"\u4ece\u6240\u6709\u7684\u542f\u52a8\u8282\u70b9\u5f00\u59cb\u521b\u5efa\u591a\u7ebf\u7a0b\u8fd0\u884c\u6574\u4e2a\u56fe", None))
#if QT_CONFIG(tooltip)
        self.actionexecute_graph.setToolTip(QCoreApplication.translate("MainWindow", u"\u4ece\u6240\u6709\u7684\u542f\u52a8\u8282\u70b9\u5f00\u59cb\u521b\u5efa\u591a\u7ebf\u7a0b\u8fd0\u884c\u6574\u4e2a\u56fe", None))
#endif // QT_CONFIG(tooltip)
        self.actionWindow2.setText(QCoreApplication.translate("MainWindow", u"\u7a97\u53e32", None))
        self.actionexetute_from_start_node.setText(QCoreApplication.translate("MainWindow", u"\u9009\u4e2d\u542f\u52a8\u8282\u70b9\u8fd0\u884c", None))
        self.actionexetute_from_start_node.setIconText(QCoreApplication.translate("MainWindow", u"\u4ece\u9009\u4e2d\u7684\u542f\u52a8\u8282\u70b9\u5f00\u59cb\u8fd0\u884c", None))
#if QT_CONFIG(tooltip)
        self.actionexetute_from_start_node.setToolTip(QCoreApplication.translate("MainWindow", u"\u4ece\u9009\u4e2d\u7684\u542f\u52a8\u8282\u70b9\u5f00\u59cb\u8fd0\u884c", None))
#endif // QT_CONFIG(tooltip)
